...
function _read<T>(func: (...args: any[]) => T, size: number): (data: Buffer, off: number) => T {
    return (data: Buffer, off: number) => {
...
function _readn<T>(func: (...args: any[]) => T): (data: Buffer, off: number, len: number) => T {
    return (data: Buffer, off: number, len: number) => {
        enforce(Buffer.isBuffer(data), 'data', 'buffer')
        enforce(off >>> 0 === off, 'off', 'integer')
...
function _readvar<T>(func: (...args: any[]) => T): (data: Buffer, off: number) => T {
    return (data: Buffer, off: number) => {
        enforce(Buffer.isBuffer(data), 'data', 'buffer')
        enforce(off >>> 0 === off, 'off', 'integer')
        return func(data, off)
...
function _write<T>(func: (...args: any[]) => T, size: number): (data: Buffer, num: number, off: number) => T {
    return (data: Buffer, num: number, off: number) => {
        enforce(Buffer.isBuffer(data), 'data', 'buffer')
        enforce(off >>> 0 === off, 'off', 'integer')
...
function _writen<T>(func: (...args: any[]) => T): (data: Buffer, num: number, off: number, len: number) => T {
    return (data: Buffer, num: number, off: number, len: number) => {
        enforce(Buffer.isBuffer(data), 'data', 'buffer')
        enforce(off >>> 0 === off, 'off', 'integer')
        enforce(len >>> 0 === len, 'len', 'integer')
...
): (data: Buffer, num: number, off: number) => T {
    return (data: Buffer, num: number, off: number) => {
        enforce(Buffer.isBuffer(data), 'data', 'buffer')
        enforce(off >>> 0 === off, 'off', 'integer')
...
export const writeVarint2 = _writecb(encoding.writeVarint2, encoding.sizeVarint2)
